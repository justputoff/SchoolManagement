...
<div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="card-text text-center text-primary">{{ $totalTeachers }}</h3>
                </div>
            </div>
        </div>
        <!-- Card 3 -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="card-title">Total</h5>
                            <p class="card-text">Paket Pembelajaran</p>
                        </div>
                        <div>
                            <i class="bx bx-book-content bx-lg"></i>
                        </div>
                    </div>
                    <h3 class="card-text text-center text-info">{{ $totalPackages }}</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card mt-4">
        <div class="card-body">
            <h5 class="card-title text-center">Jumlah Siswa Baru Tiap Bulan</h5>
